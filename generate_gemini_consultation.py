#!/usr/bin/env python3
"""
Gemini CLI Consultation for OLAV Architecture

This script generates the consultation prompt for Gemini CLI,
...
if __name__ == "__main__":
    ...
    print("   2. Edit if needed: vim {filepath}")
    print("   3. Run Gemini CLI: gemini chat -f {filepath}")
    print()
    print("⚠️  Note: If gemini CLI is running, stop it first:")
    print("   pkill -f gemini")
    print("   gemini chat -f {filepath}")
