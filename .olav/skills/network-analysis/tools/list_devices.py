#!/usr/bin/env python3
"""
List Devices - Wrapper importing from shared tools.

This tool is implemented in .olav/shared/tools/list_devices.py
"""
...
from tools.list_devices import main, DateTimeEncoder
import json
