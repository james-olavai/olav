#!/usr/bin/env python3
"""
Inspect Schema - Wrapper importing from shared tools.

This tool is implemented in .olav/shared/tools/inspect_schema.py
"""
...
from tools.inspect_schema import main, DateTimeEncoder
import json
