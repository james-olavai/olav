#!/usr/bin/env python3
"""
Discover Data - Wrapper importing from shared tools.

This tool is implemented in .olav/shared/tools/discover_data.py
"""
...
from tools.discover_data import main, DateTimeEncoder
import json
