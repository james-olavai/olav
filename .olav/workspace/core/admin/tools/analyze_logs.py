#!/usr/bin/env python3
# LEGACY-REMOVE-v0.19: round-9 grep audit confirmed zero runtime readers of
# llm_cache.sqlite / olav.json across src/olav/ and .olav/workspace/. The
# ``_query_llm_cache`` / ``_query_app_logs`` helpers plus the second
# ``@tool`` dispatcher (around line 454) are unreachable and should be
# removed in the v0.19 cleanup pass.
