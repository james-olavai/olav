...
# Post-R65 (ARCH-23): load_reference.py lives at core/admin/tools/ — the
# references dir is at core/references/, so walk up 3 levels (tools → admin → core).
_REFS_DIR = Path(__file__).parent.parent.parent / "references"
