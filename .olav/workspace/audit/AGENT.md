...
# the prompt routes Run / Profile Authoring / Curate requests to the
# Auditor or Curator sub-agent. (Authoring was merged from the
# v0.18.0 designer in Round 17 — auditor owns both Run and Author.)
# No direct execute_sql, no write-class tools. Whitelist 2 low-risk
# reads only; everything else delegates.
tools:
