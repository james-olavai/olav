"""test_map_query.py — Trial-run a Profile Job query and preview results.

The Designer Agent uses this to validate SQL / LanceDB queries before
committing them to a Profile. Always uses parameterized binding — never
interpolates the window value into the SQL string.
"""
...
def test_map_query(
    ...
    try:
        ...
        return [{"error": str(exc), "hint": "Fix the query and call test_map_query again"}]
