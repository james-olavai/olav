...
tools:
  ...
  - read_api_schema              # Compact OpenAPI summary (fallback; prefer sandbox exploration)
  ...
  - extract_schema_reference     # Extract query params → schema_reference.json (schema-aware)
