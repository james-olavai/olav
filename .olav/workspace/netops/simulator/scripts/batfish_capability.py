...
Thin script wrapper around ``olav_netops.core.sim.batfish_capability``.  Call
...
from olav_netops.core.sim.batfish_capability import batfish_capability as _batfish_capability
