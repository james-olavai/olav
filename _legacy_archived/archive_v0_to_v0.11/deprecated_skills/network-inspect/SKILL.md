...
SELECT unnest(data).neighbor_id, unnest(data).state
FROM read_json_auto('exports/snapshots/latest/parsed/R1/show-ip-ospf-neighbor.json')
```

**Secondary: Database Tools**
