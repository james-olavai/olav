#!/usr/bin/env python3
"""
Query Database - Wrapper importing from shared tools.

This tool is implemented in .olav/shared/tools/query_database.py
"""
...
from tools.query_database import main, DateTimeEncoder
import json
