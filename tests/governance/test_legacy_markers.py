...
_ALLOWLIST: set[Path] = {
    ...
    REPO / "src" / "olav" / "data" / "workspace" / "audit" / "runner" / "tools" / "map_engine.py",
    REPO / "src" / "olav" / "data" / "workspace" / "audit" / "runner" / "scripts" / "map_engine.py",
    REPO / "src" / "olav" / "data" / "workspace" / "audit" / "author" / "tools" / "list_profiles.py",
    REPO / "src" / "olav" / "data" / "workspace" / "core" / "tools" / "format_and_export.py",
    REPO / "src" / "olav" / "data" / "workspace" / "core" / "tools" / "recall_memory.py",
    REPO / "src" / "olav" / "data" / "workspace" / "core" / "scripts" / "format_and_export.py",
    REPO / "src" / "olav" / "data" / "workspace" / "core" / "scripts" / "recall_memory.py",
