...
_LEGITIMATE_USAGE_FILES: frozenset[str] = frozenset({
    ...
    "src/olav/data/workspace/audit/runner/tools/map_engine.py",
    "src/olav/data/workspace/audit/runner/scripts/map_engine.py",
    "src/olav/data/workspace/audit/author/tools/list_profiles.py",
