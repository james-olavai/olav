...
async def test_time_filter():
    ...
    unique_peers_all = {r["peer"] for r in result_all["data"]}
    ...
    unique_peers_24h = {r["peer"] for r in result_24h["data"]}
    ...
    unique_peers_12h = {r["peer"] for r in result_12h["data"]}
