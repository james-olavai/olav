...
class TestStandardModeToolCalls:
    ...
    async def test_s01_suzieq_query_tool(self, api_client):
        ...
        async with api_client as client:
            ...
            assert any(kw in output for kw in ["interface", "device", "接口", "设备", "status", "状态"])
    ...
    async def test_s02_netbox_query_tool(self, api_client):
        ...
        async with api_client as client:
            ...
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "列出 NetBox 中所有设备"}},
            )
            ...
            # Should mention NetBox or device list
            output = str(result["output"]).lower()
            # Accept either success or "no devices" result
            assert any(kw in output for kw in ["netbox", "device", "设备", "inventory", "dcim"])
    ...
    async def test_s03_syslog_search_tool(self, api_client):
        ...
        async with api_client as client:
            ...
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "搜索最近的 BGP 相关日志"}},
            )
            ...
            output = str(result["output"]).lower()
            assert any(kw in output for kw in ["log", "syslog", "日志", "bgp", "event", "no.*found", "未找到"])
...
class TestNetBoxCRUDOperations:
    ...
    async def test_n01_netbox_list_devices(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "从 NetBox 获取所有设备列表"}},
            )
    ...
    async def test_n02_netbox_get_device_info(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "查询 NetBox 中 R1 设备的详细信息"}},
            )
...
class TestCLIExecution:
    ...
    async def test_c01_cli_show_command(self, api_client):
        ...
        async with api_client as client:
            ...
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 R1 上执行 show version 命令"}},
            )
            ...
            output = str(result["output"]).lower()
            assert any(kw in output for kw in [
...
class TestHITLTrigger:
    ...
    async def test_h01_netbox_create_device(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 NetBox 中创建一个新设备 TestDevice01，设备类型为 Cisco Router，站点为 DC1"}},
            )
            ...
            assert any(kw in output for kw in hitl_keywords)
    ...
    async def test_h02_netbox_delete_device(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "从 NetBox 中删除设备 TestDevice01"}},
            )
    ...
    async def test_h03_r1_netconf_create_acl(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 R1 上使用 OpenConfig 创建 ACL test，添加规则 index 10 deny any any"}},
            )
    ...
    async def test_h04_r1_netconf_modify_acl(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 R1 上修改 ACL test 的规则 index 10，将 deny any any 改为 permit any any"}},
            )
    ...
    async def test_h05_r3_cli_create_loopback(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 R3 上创建 Loopback10 接口，描述为 test，IP 地址 10.10.10.10/32。注意：R3 不支持 OpenConfig，请使用 CLI"}},
            )
            ...
            # Should NOT use NETCONF for R3
            # (This is a soft check - the agent should choose CLI)
    ...
    async def test_h06_r3_cli_delete_loopback(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "在 R3 上删除 Loopback10 接口。注意：R3 不支持 OpenConfig，请使用 CLI"}},
            )
...
class TestKnowledgeBaseLayers:
    ...
    async def test_k01_openconfig_schema_search(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "查找 BGP 相关的 OpenConfig YANG 路径"}},
            )
    ...
    async def test_k02_document_search(self, api_client):
        ...
        async with api_client as client:
            response = await client.post(
                "/orchestrator/invoke",
                json={"input": {"query": "搜索关于 OSPF 配置的文档"}},
            )
