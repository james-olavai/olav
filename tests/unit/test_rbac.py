...
# ── 10. RBAC migration ───────────────────────────────────────────────────────
# (v0_13_rbac migration removed in ARCH-22 B — role_skill_permissions table
# was never wired into the runtime authz path; DEFAULT_PERMISSIONS is the
# sole source of truth. See tests/governance/test_compat_cutoff.py.)
