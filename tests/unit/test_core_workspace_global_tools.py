...
This ensures recall_memory, execute_sql, etc. are available in every agent.
"""
...
class TestCoreWorkspaceGlobalTools:
    ...
    def test_core_tools_loaded_when_core_skill_exists(self, tmp_path):
        ...
        _make_skill_md(olav_base / "workspace" / "core", ["recall_memory"])
        ...
        assert "recall_memory" in tool_names, "core tool recall_memory should be loaded"
    ...
    def test_no_core_tools_when_core_workspace_absent(self, tmp_path):
        ...
        assert "recall_memory" not in tool_names  # core absent
    ...
    def test_core_tools_first_agent_tools_second(self, tmp_path):
        ...
        core_idx = tool_names.index("recall_memory")
