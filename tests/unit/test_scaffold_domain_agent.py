...
─────────────────────────────────────────
TDD guard for .olav/workspace/config/discovery/tools/scaffold_domain_agent.py
...
def _load_scaffold():
    """Load scaffold_domain_agent from its workspace location."""
    tool_path = Path(".olav/workspace/config/discovery/tools/scaffold_domain_agent.py")
    spec = importlib.util.spec_from_file_location("scaffold_domain_agent", tool_path)
