...
Intended LLM workflow for CLI execution:
  ...
  3. execute_cli(device="R1", command="show ip ospf neighbor")
...
Usage in DeepAgents:
    from .tools import search_commands
    agent = create_deep_agent(tools=[search_commands.search_commands])
"""
    ...
    Returns:
        {
          ...
          "note": "pipe_allowed=true means | filters are permitted in execute_cli"
        }
    """
...
if __name__ == "__main__":
    try:
        ...
        result = search_commands.func(**params)
