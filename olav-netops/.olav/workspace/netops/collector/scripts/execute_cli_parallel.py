...
def execute_cli_parallel(
    ...
    FALLBACK TOOL. Use execute_sql first. Only use when live data is
    required. Use tool_help("execute_cli_parallel") for full usage.
...
if __name__ == "__main__":
    ...
    result = execute_cli_parallel(**_args)
