...
1. **simulator** — BGP, OSPF, static routes, routing analysis + deterministic What-If simulation (networkx + netutils sandbox). Replaces `routing` (v1) and `simulation` (v0.1).
