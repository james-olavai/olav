...
⚠️ **Do not reference** the following — they were planned but never
materialised (or were deleted in R70):
...
`netops.ospf_adjacencies`.  For interface / ARP / route / MAC data,
JSON-extract from `netops.parsed_outputs.parsed_data`.
