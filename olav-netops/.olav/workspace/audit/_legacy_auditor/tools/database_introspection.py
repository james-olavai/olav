"""database_introspection.py — Query DuckDB/LanceDB schema for Profile design.

Returns a structured dict of table names → column lists so the Designer Agent
can write correct SQL without hallucinating column names.
"""
