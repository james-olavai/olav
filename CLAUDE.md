...
- `.olav/workspace/core/**`, `.olav/workspace/audit/**`, `.olav/workspace/netops/**` — tracked workspace agents
- `src/olav/data/workspace/services/**` — authoritative service-integration tool source
