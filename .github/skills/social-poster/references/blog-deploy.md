...
SLUG=$(grep "Blog Slug" /home/yhvh/Olav/olav-post/archive/YYYY-MM-DD/_meta.md | awk '{print $NF}')

ls /home/yhvh/Olav/olav-web/src/content/blog/${SLUG}.md
ls /home/yhvh/Olav/olav-web/src/content/blog-zh/${SLUG}.md
ls /home/yhvh/Olav/olav-web/public/blog-images/${SLUG}/og-image.webp
```

If EN blog file is **missing**, copy from archive:

```bash
cp /home/yhvh/Olav/olav-post/archive/YYYY-MM-DD/olav.md \
   /home/yhvh/Olav/olav-web/src/content/blog/${SLUG}.md
```
...
```bash
cd /home/yhvh/Olav
uv run python .github/skills/content-writer/scripts/gen_blog_images.py ${SLUG}
```
