...
```
mcp_chrome-devtoo_take_snapshot → find button "Add a photo" or image upload icon in composer
mcp_chrome-devtoo_upload_file
  uid: <file input ref>
  filePath: /home/yhvh/Olav/olav-post/archive/YYYY-MM-DD/images/diagram-1.webp
mcp_chrome-devtoo_wait_for → text: ["Photo added", "1 image"]
```
