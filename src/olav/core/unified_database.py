...
class UnifiedDatabase:
    ...
    def get_network_summary(self) -> dict[str, Any]:
        ...
        cmd_count = self.conn.execute(
            "SELECT COUNT(*) FROM commands.capabilities"
        ).fetchone()[0]
    ...
    def audit_command_authorization(
        self, hours: int = 24
    ) -> list[dict[str, Any]]:
