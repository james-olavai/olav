...
def _load_parse_src_token():
    ...
    # rev ~296: runner/ dir renamed → audit-runner/ (SkillsMiddleware spec compliance).
    # tools/ → scripts/ migration: probe scripts/ first, then tools/ for compat.
    _LAYOUTS = (
        (".olav", "workspace", "audit", "audit-runner", "scripts", "render_report.py"),
        (".olav", "workspace", "audit", "audit-runner", "tools", "render_report.py"),
