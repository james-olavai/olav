...
Refactored: Uses LangChain with_structured_output() instead of manual JSON parsing.
"""
...
class HypothesesList(BaseModel):
    ...
    hypotheses: list[HypothesisOutput] = Field(description="List of hypotheses, ordered by confidence")
...
"""
        ...
        try:
            ...
            verification: VerificationPlan = await structured_llm.ainvoke([SystemMessage(content=prompt)])
