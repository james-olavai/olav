...
@tool
def workspace_health(agent_dir: str = "") -> str:
    """Check workspace health: audit .olav/workspace/ for code quality issues.
...
if __name__ == "__main__":
    result = json.loads(audit_workspace.invoke({"agent_dir": ""}))
    print(result["report"])
