...
# Candidate agent directories — scanned for AGENT.md / SKILL.md static_context
# entries. Updated for v0.11.0 agent layout: ops/ removed (moved to netops/),
# admin/ and devops/ added.
_AGENT_DIRS = [
    _PROJECT_ROOT / ".olav" / "workspace" / "core",
    _PROJECT_ROOT / ".olav" / "workspace" / "admin",
    _PROJECT_ROOT / ".olav" / "workspace" / "audit",
    _PROJECT_ROOT / ".olav" / "workspace" / "devops",
]
...
if __name__ == "__main__":
    ...
    result = get_static_context(**_args)
