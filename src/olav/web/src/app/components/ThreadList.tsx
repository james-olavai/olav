                      ...
                      >
                        ...
                        {onDeleteThread && (
                          <button
                            ...
                            className="absolute right-1 top-1/2 -translate-y-1/2 flex min-h-8 min-w-8 items-center justify-center rounded-md p-2 hover:bg-destructive/10 text-muted-foreground hover:text-destructive touch-manipulation"
