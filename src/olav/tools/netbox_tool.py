...
@tool
def netbox_api_call(path: str, method: str, data: Optional[Dict] = None, params: Optional[Dict] = None) -> Dict[str, Any]:
    """
    ...
    """
    url = f"{settings.netbox_url}/api{path}" if not path.startswith("/api") else f"{settings.netbox_url}{path}"
    headers = {
