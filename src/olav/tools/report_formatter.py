...
def generate_network_operations_report(sync_dir: Path, device_names: list[str]) -> None:
    ...
    Creates a single YYYYMMDD.md report in exports/reports/snapshots/.
    ...
    try:
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Auto-generated by OLAV v0.9.2*")
        lines.append("")
