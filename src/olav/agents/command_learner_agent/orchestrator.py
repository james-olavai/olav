"""
Command Learner Workflow Orchestrator
...
class CommandLearnerOrchestrator:
    """
    Orchestrates the complete 6-step command learning workflow.
    ...
    def __init__(
        ...
        self.generation_agent = CommandLearnerAgent(
        ...
        logger.info(
            f"Initialized CommandLearnerOrchestrator "
    ...
    async def run_workflow(
        ...
        try:
            ...
            metadata = TemplateMetadata(
                ...
                filename=filename,
                file_path=file_path,
                generated_by="command_learner_agent_v1",
